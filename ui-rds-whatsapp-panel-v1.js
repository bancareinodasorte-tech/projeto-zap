...
async function waPage(){
 try{
  ...
  app.innerHTML='<section class="rds-wa-app"><aside class="rds-wa-sidebar"><div class="rds-wa-head"><div><span class="eyebrow">ATENDIMENTO</span><h1>WhatsApp</h1></div><span class="rds-wa-state '+(d.connected?'on':'off')+'">● '+(d.connected?'Conectado':'Offline')+'</span></div><div class="rds-wa-actions">'+(d.connected?B('↻ Atualizar','rdsWaReload()'):B('Conectar WhatsApp','rdsWaConnect()','btn primary'))+'</div><div id="rdsWaQr"></div><div class="rds-wa-search"><span>⌕</span><input id="rdsWaSearch" placeholder="Pesquisar conversas..."></div><div id="rdsWaChats"></div></aside><section class="rds-wa-chat"><div id="rdsWaEmpty" class="rds-wa-empty"><div class="rds-wa-logo">◉</div><h2>Central de conversas</h2><p>Selecione uma conversa para iniciar o atendimento.</p><small>As mensagens recebidas e enviadas pelo canal aparecem aqui.</small></div><div id="rdsWaConversation" hidden></div></section></section>';
