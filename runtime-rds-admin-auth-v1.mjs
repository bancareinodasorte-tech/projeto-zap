...
if(server.includes(marker)){console.log('[RDS] admin auth V1 já aplicada');process.exit(0);}
...
app.get('/admin-recuperar',(req,res)=>res.sendFile(__dirname+'/admin-recuperar.html'));
